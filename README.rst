...
discrepancy sequence quality. This repository accompanies the paper:

`Sobol Direction Numbers for Quasi-Monte Carlo Simulation: Construction, Pathwise Dependence Diagnostics, and Financial Pricing Benchmarks <https://ssrn.com/abstract=7040539>`_.
...
We provide two categories of examples:

The first category of examples showcase how to use the package and perform standard QMC testing, the second category of
examples provided are notebooks which can be used to recreate the results in the aforementioned paper. The former can be
found in the `<notebooks>`_ folder, whilst the latter in `<notebooks/paper_notebooks>`_:
...
If you use this codebase, please cite our work using the following citation:

.. code-block:: RST

    Oliva Denis, Andres, Wheeldon, James, Manyakin, Ilya. and Papaioannou, Adrien.
    "Sobol Direction Numbers for Quasi-Monte Carlo Simulation: Construction, Pathwise Dependence Diagnostics,
    and Financial Pricing Benchmarks". Available at SSRN: https://ssrn.com/abstract=7040539 (2026).
